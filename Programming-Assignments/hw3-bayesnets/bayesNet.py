...
class BayesNet(object):
    ...
    def __init__(self, variables, inputInEdges, inputOutEdges, inputVariableDomains):
        ...
        variables:       An iterable of all the variables.
    ...
    def getCPTWithEvidence(self, variable, evidenceDict=None):
        ...
        the CPT may have fewer rows than what
...
class Factor(object):
    ...
    def setProbability(self, assignmentDict, probability):
        ...
        """
        if probability < 0:
            raise ValueError("Probability entries can't be set to negative values: " + \
                             str(probability))
        else:
    ...
    def __str__(self):
        ...
        # code for checking whether to print horizontal line
